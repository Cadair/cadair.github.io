...
_magic_number = 9
_modified_time = 1391295175.962852
_enable_loop = True
_template_filename = u'themes/stuart/templates/homepage.tmpl'
_template_uri = u'homepage.tmpl'
_source_encoding = 'utf-8'
_exports = [u'jumbo', u'extra_head', u'content']
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        def jumbo():
            return render_jumbo(context._locals(__M_locals))
        ...
        # SOURCE LINE 7
        __M_writer(u'\n')
        if 'parent' not in context._data or not hasattr(context._data['parent'], 'jumbo'):
            context['self'].jumbo(**pageargs)
...
def render_jumbo(context,**pageargs):
    __M_caller = context.caller_stack._push_frame()
    try:
        def jumbo():
            return render_jumbo(context)
        __M_writer = context.writer()
        # SOURCE LINE 8
        __M_writer(u'\n<div class=\'jumbotron\'>\n<div class="photo-copy"><small>&copy; Robert Pfau</small></div>\n</div>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
