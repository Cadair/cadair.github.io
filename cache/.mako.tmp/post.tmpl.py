...
_magic_number = 9
_modified_time = 1391295175.764008
_enable_loop = True
_template_filename = u'/usr/lib/python2.7/site-packages/nikola/data/themes/bootstrap3/templates/post.tmpl'
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'" itemprop="datePublished">')
        ...
        if post.description():
            # SOURCE LINE 27
            __M_writer(u'        <meta content="')
            __M_writer(unicode(post.description()))
            __M_writer(u'" itemprop="description">\n')
        # SOURCE LINE 29
        __M_writer(u'    </div>\n    ')
        # SOURCE LINE 30
